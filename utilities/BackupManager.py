    ...
    def backup_old_links_files():
        try:
            ...
            old_links_files = [
                ...
                if "google_maps_links" in file and file.endswith(".txt")
            ]
            ...
            for file in old_links_files:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    destination_path = os.path.join(
                        os.getcwd(), backup_folder, new_file
                    )
                    shutil.move(temp_file, destination_path)
                os.remove(source_path)

            if old_links_files:
                print("[INFO] Successfully backed up last session.")
            else:
                print("[INFO] No previous session found, continuing without backup.\n")
        except Exception:
            print("[INFO] No previous session found, continuing without backup.\n")
